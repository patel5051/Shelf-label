  ...
  const onSubmit = (data: ItemFormValues) => {
    createItem.mutate({ data }, {
      onSuccess: () => {
        toast({
          title: "Item created",
          description: `${data.description} has been added to the catalogue.`,
        });
      ...
      onError: (err) => {
        ...
        toast({
          ...
          description: msg || "Failed to create item. Please check your data.",
          variant: "destructive",
        });
      }
    });
      ...
      <div className="max-w-3xl mx-auto p-8 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">Create a new product in your catalogue</p>
          </div>
        </div>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>Enter the product information precisely as it should appear on shelf labels.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex justify-end gap-3 pt-6 border-t border-border mt-8">
                  ...
                  <Button type="submit" disabled={createItem.isPending} className="shadow-xs">
